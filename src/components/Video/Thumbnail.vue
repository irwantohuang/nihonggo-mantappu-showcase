...
import { convertToMMSS } from '../../utils/videoHelper'
defineProps({
    video: Object
})
</script>
...
<template>
    ...
    <img :src="video?.snippet.thumbnails.maxres.url" :alt="video?.snippet.title" class=" h-full w-full object-fill rounded-md"> 
